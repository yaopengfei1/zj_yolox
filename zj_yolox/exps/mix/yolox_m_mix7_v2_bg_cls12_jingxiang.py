...
class Exp(MyExp):
    def __init__(self):
        ...
        self.data_dir = "/data/ypf/yingyu_caiji/mix7_v2_bg/cls12"
        self.train_ann = "train_cls12_mix7_v2_bg_jx_tm.json"
        self.val_ann = "val_cls12_mix7_v2_bg.json"
        self.test_ann = "val_cls12_mix7_v2_bg.json"

...
class Exp(MyExp):
    def __init__(self):
        ...
        self.data_dir = "/ypf/yingyu_caiji/zx2-1m/cls12/"
        self.train_ann = "train_cls12_zx2-1m.json"
        self.val_ann = "val_cls12_zx2-1m.json"
        self.test_ann = "val_cls12_zx2-1m.json"

...
class Exp(MyExp):
    def __init__(self):
        ...
        self.data_dir = "/data/ypf/yingyu_caiji/mix7_v2/cls12"
        self.train_ann = "train_cls12_mix7_v2_gl_erwema_yiwu_beijing.json"
        # self.val_ann = "val_cls12_mix7_v2.json"
        # self.test_ann = "val_cls12_mix7_v2.json"
        self.val_ann = "529.json"
        self.test_ann = "529.json"
        self.train_dir = 'image'
        self.test_dir = 'image'
        self.val_dir = 'image'
        self.max_epoch = 300

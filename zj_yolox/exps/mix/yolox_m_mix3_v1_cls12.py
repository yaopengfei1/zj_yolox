...
class Exp(MyExp):
    def __init__(self):
        ...
        self.data_dir = "/data/ypf/yingyu_caiji/mix3_v1/cls12"
        self.train_ann = "train_cls12_mix3_v1.json"
        self.val_ann = "val02_cls12_zx2-1l.json"
        self.test_ann = "val02_cls12_zx2-1l.json"

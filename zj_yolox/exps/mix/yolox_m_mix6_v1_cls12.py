...
class Exp(MyExp):
    def __init__(self):
        ...
        self.data_dir = "/data/ypf/yingyu_caiji/mix6_v1/cls12"
        self.train_ann = "train_cls12_mix6_v1.json"
        self.val_ann = "val_cls12_mix6_v1.json"
        self.test_ann = "val_cls12_mix6_v1.json"

...
class Exp(MyExp):
    def __init__(self):
        ...
        self.train_ann = "train_cls12_mix7_v2_ex_3000_ad_ft.json"
        self.val_ann = "val_cls12_mix7_v2_ex_3000_ad_ft.json"
        self.test_ann = "val_cls12_mix7_v2_ex_3000_ad_ft.json"

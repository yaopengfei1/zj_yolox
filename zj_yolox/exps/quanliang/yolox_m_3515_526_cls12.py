...
class Exp(MyExp):
    def __init__(self):
        ...
        self.data_dir = "/data/ypf/quanliang/all_test"
        self.train_ann = "train_cls12_mix3_sp.json"
        self.val_ann = "GUANGYU3515-20220526182129.json"
        self.test_ann = "GUANGYU3515-20220526182129.json"
        self.train_dir = 'images'
        self.test_dir = '526/GUANGYU3515-20220526182129'
        self.val_dir = 'images'
        self.max_epoch = 300

...
class Exp(MyExp):
    def __init__(self):
        ...
        # self.data_dir = "/data/ypf/yingyu_caiji/mix7_v2/cls12/annotations/mix_eval_single"
        self.data_dir = "/data/ypf/yingyu_caiji/pw1-1_wh/cls12/"
        # self.train_ann = "train5_cls12_zx2-1l.json"
        self.val_ann = "val_cls12_pw1-1_wh.json"
        self.test_ann = "val_cls12_pw1-1_wh.json"

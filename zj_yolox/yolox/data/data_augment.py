...
def get_affine_matrix2(
    ...
    # Combined rotation matrix, @为矩阵乘法运算符
...
def random_affine(
    ...
    M, scale = get_affine_matrix2(img, target_size, degrees, translate, scales, shear)
...
def preproc(img, input_size, swap=(2, 0, 1)):
    ...
    #cv2.imwrite(f'/lsc/zj_yolox/aug_img/{x}_preproc.jpeg',padded_img)
...
class TrainTransform:
    ...
    def __call__(self, image, targets, input_dim):
        ...
        if len(boxes_t) == 0:
            ...
            boxes_o *= r_o
            boxes_t = boxes_o[mask_b]
            labels_t = labels_o[mask_b]
